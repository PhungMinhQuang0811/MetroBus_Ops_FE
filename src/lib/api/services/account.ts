...
export const accountApi = {
  ...
  resetAccountPassword: (accountId: string, body: ResetAccountPasswordRequest) =>
    apiRequest<ResetAccountPasswordResponse>(API_ENDPOINTS.account.resetAccountPassword(accountId), { service: "auth", method: "POST", body }),
}
